...
var Dajaxice = {
    ...
    load_airport: function(callback_function, argv, custom_settings){
        Dajaxice.call('web.load_airport', 'POST', callback_function, argv, custom_settings);
    },

    get_count: function(callback_function, argv, custom_settings){
        Dajaxice.call('web.get_count', 'POST', callback_function, argv, custom_settings);
    }

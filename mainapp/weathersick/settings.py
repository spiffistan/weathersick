# Django settings for weathersick project.
...
SECRET_KEY = '8vzq0(z6($nq-*76d4feqz7w5s8tt%2e*8q92zz#7jagn3bye6'
...
ROOT_URLCONF = 'weathersick.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'weathersick.wsgi.application'
